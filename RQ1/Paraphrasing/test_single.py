...
# score_humaneval = model.test(filename='paraphrased_humaneval.csv', output_dir=output_dir_humaneval)
...
score_openeval = model.test(filename='paraphrased_openeval.csv', output_dir=output_dir_openeval)
...
# # 选择输入文件
# if model_name in ['ours_2','ours_4','ours_6']:
#     input_humaneval_file = 'paraphrased_ASR_humaneval.csv'
#     input_openeval_file = 'paraphrased_ASR_openeval.csv'
