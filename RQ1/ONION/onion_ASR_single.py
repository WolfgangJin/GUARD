...
# 定义输出目录
output_dir_humaneval = f'ONION/results/{model_name}/test_humaneval/'
output_dir_openeval = f'ONION/results/{model_name}/test_openeval/'
...
# score_humaneval = model.test(filename='ONION/onion_humaneval.csv', output_dir=output_dir_humaneval)
...
# score_openeval = model.test(filename='ONION/onion_openeval.csv', output_dir=output_dir_openeval)
